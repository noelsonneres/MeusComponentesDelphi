...
// (DO NOT EDIT: machine generated header) 'frxDB26.dpk' rev: 33.00 (Windows)
...
#include <frxConnWizard.hpp>
#include <frxCustomDB.hpp>
#include <frxCustomDBEditor.hpp>
#include <frxCustomDBRTTI.hpp>
#include <frxEditMD.hpp>
#include <frxEditQueryParams.hpp>
#include <frxEditSQL.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXDB26)
using namespace Frxdb26;
#endif
#pragma pack(pop)
#pragma option pop
