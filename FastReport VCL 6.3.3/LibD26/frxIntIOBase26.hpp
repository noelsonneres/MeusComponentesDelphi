...
// (DO NOT EDIT: machine generated header) 'frxIntIOBase26.dpk' rev: 33.00 (Windows)

#ifndef Frxintiobase26HPP
#define Frxintiobase26HPP
...
#include <frxIOTransportIntDialog.hpp>
#include <frxFPUMask.hpp>
#include <frxSaveFilterBrowser.hpp>
...
namespace Frxintiobase26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Frxintiobase26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXINTIOBASE26)
using namespace Frxintiobase26;
#endif
#pragma pack(pop)
#pragma option pop
