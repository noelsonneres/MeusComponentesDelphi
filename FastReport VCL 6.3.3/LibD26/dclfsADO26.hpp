...
// (DO NOT EDIT: machine generated header) 'dclfsADO26.dpk' rev: 33.00 (Windows)

#ifndef Dclfsado26HPP
#define Dclfsado26HPP
...
namespace Dclfsado26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsado26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSADO26)
using namespace Dclfsado26;
#endif
#pragma pack(pop)
#pragma option pop
