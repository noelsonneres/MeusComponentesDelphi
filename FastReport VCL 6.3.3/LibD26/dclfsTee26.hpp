...
// (DO NOT EDIT: machine generated header) 'dclfsTee26.dpk' rev: 33.00 (Windows)

#ifndef Dclfstee26HPP
#define Dclfstee26HPP
...
namespace Dclfstee26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfstee26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSTEE26)
using namespace Dclfstee26;
#endif
#pragma pack(pop)
#pragma option pop
