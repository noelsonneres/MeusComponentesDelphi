...
// (DO NOT EDIT: machine generated header) 'dclfrxADO26.dpk' rev: 33.00 (Windows)

#ifndef Dclfrxado26HPP
#define Dclfrxado26HPP
...
#include <frxADORTTI.hpp>	// (frxADO26)
#include <frxADOEditor.hpp>	// (frxADO26)
#include <frxADOComponents.hpp>	// (frxADO26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxado26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxado26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXADO26)
using namespace Dclfrxado26;
#endif
#pragma pack(pop)
#pragma option pop
