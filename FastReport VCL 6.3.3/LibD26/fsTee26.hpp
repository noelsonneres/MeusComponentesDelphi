...
// (DO NOT EDIT: machine generated header) 'fsTee26.dpk' rev: 33.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSTEE26)
using namespace Fstee26;
#endif
#pragma pack(pop)
#pragma option pop
