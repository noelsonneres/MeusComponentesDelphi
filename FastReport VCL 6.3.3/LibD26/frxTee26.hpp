...
// (DO NOT EDIT: machine generated header) 'frxTee26.dpk' rev: 33.00 (Windows)
...
#include <frxChartEditor.hpp>
#include <frxChartInPlaceEditor.hpp>
#include <frxChartClipboard.hpp>
#include <frxChartHelpers.hpp>
#include <frxChartRTTI.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXTEE26)
using namespace Frxtee26;
#endif
#pragma pack(pop)
#pragma option pop
