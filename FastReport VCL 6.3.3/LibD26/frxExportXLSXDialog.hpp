...
// (DO NOT EDIT: machine generated header) 'frxExportXLSXDialog.pas' rev: 33.00 (Windows)
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfrxXLSXExportDialog(System::Classes::TComponent* AOwner) : Frxexportbasedialog::TfrxBaseExportDialog(AOwner) { }
	...
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfrxXLSXExportDialog() { }
