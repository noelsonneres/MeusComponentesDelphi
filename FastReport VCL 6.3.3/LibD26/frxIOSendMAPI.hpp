...
// (DO NOT EDIT: machine generated header) 'frxIOSendMAPI.pas' rev: 33.00 (Windows)

#ifndef FrxiosendmapiHPP
#define FrxiosendmapiHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXIOSENDMAPI)
using namespace Frxiosendmapi;
#endif
#pragma pack(pop)
#pragma option pop
