...
// (DO NOT EDIT: machine generated header) 'dclfsDB26.dpk' rev: 33.00 (Windows)
...
#include <fs_idbctrlsrtti.hpp>	// (fsDB26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSDB26)
using namespace Dclfsdb26;
#endif
#pragma pack(pop)
#pragma option pop
