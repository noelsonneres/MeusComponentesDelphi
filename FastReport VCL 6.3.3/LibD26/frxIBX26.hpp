...
// (DO NOT EDIT: machine generated header) 'frxIBX26.dpk' rev: 33.00 (Windows)
...
#include <frxIBXEditor.hpp>
#include <frxIBXRTTI.hpp>
...
#include <fs_iibxrtti.hpp>	// (fsIBX26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXIBX26)
using namespace Frxibx26;
#endif
#pragma pack(pop)
#pragma option pop
