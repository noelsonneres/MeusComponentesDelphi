...
// (DO NOT EDIT: machine generated header) 'dclfs26.dpk' rev: 33.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFS26)
using namespace Dclfs26;
#endif
#pragma pack(pop)
#pragma option pop
