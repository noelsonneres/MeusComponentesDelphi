...
// (DO NOT EDIT: machine generated header) 'dclfrxe26.dpk' rev: 33.00 (Windows)
...
#include <frxrcExports.hpp>	// (frxe26)
#include <frxNetUtils.hpp>	// (frx26)
#include <frxGradientRTTI.hpp>	// (frx26)
#include <frxGradient.hpp>	// (frx26)
#include <frxCrypto.hpp>	// (frxe26)
#include <frxExportHelpers.hpp>	// (frxe26)
#include <frxTrueTypeFont.hpp>	// (frxe26)
#include <frxTrueTypeCollection.hpp>	// (frxe26)
#include <frxEMFFormat.hpp>	// (frxe26)
#include <frxExportPDFHelpers.hpp>	// (frxe26)
#include <frxExportODF.hpp>	// (frxe26)
#include <frxBIFF.hpp>	// (frxe26)
#include <frxExportDOCX.hpp>	// (frxe26)
#include <frxExportPPTX.hpp>	// (frxe26)
#include <frxExportXLSX.hpp>	// (frxe26)
#include <frxExportHTML.hpp>	// (frxe26)
#include <frxChBoxRTTI.hpp>	// (frx26)
#include <frxChBox.hpp>	// (frx26)
#include <frxExportPDF.hpp>	// (frxe26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXE26)
using namespace Dclfrxe26;
#endif
#pragma pack(pop)
#pragma option pop
