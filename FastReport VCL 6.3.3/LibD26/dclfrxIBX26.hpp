...
// (DO NOT EDIT: machine generated header) 'dclfrxIBX26.dpk' rev: 33.00 (Windows)

#ifndef Dclfrxibx26HPP
#define Dclfrxibx26HPP
...
#include <frxIBXRTTI.hpp>	// (frxIBX26)
#include <frxIBXEditor.hpp>	// (frxIBX26)
#include <frxIBXComponents.hpp>	// (frxIBX26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxibx26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxibx26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXIBX26)
using namespace Dclfrxibx26;
#endif
#pragma pack(pop)
#pragma option pop
