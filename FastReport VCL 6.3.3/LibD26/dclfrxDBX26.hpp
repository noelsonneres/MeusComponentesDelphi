...
// (DO NOT EDIT: machine generated header) 'dclfrxDBX26.dpk' rev: 33.00 (Windows)

#ifndef Dclfrxdbx26HPP
#define Dclfrxdbx26HPP
...
#include <frxDBXRTTI.hpp>	// (frxDBX26)
#include <frxDBXEditor.hpp>	// (frxDBX26)
#include <frxDBXComponents.hpp>	// (frxDBX26)
// PRG_EXT: .bpl
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Dclfrxdbx26
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxdbx26 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDBX26)
using namespace Dclfrxdbx26;
#endif
#pragma pack(pop)
#pragma option pop
