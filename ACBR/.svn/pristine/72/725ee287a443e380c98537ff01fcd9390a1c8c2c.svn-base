...
uses
  ...
  Menus, StdCtrls, ACBrSpedPisCofins, DB, DBClient, ACBrEPCImportar, Grids, DBGrids,
  ACBrEPCBloco_C, ACBrEPCBlocos;
...
begin
  ...
  begin
    ...
    SpedPCImp.Importar;
    LblEmp.Caption := 'Empresa: ' + SPEDPisCofins.Bloco_0.Registro0000.NOME;
    Gen_C100;
  end;
end;
...
begin
  ...
  try
    with SPEDPisCofins.Bloco_C.RegistroC001 do
        ...
        with RegistroC010.Items[I] do
          for J := 0 to RegistroC100.Count - 1 do
            ...
            begin
              ...
              CDS_C100COD_SIT.AsString      := CodSitToStr(COD_SIT);
              ...
              CDS_C100IND_FRT.AsString      := IndFrtToStr(IND_FRT);
...
begin
  for I := 0 to ARegC170.Count - 1 do
    ...
    begin
      ...
      CDS_C170CST_ICMS.AsString     := CstIcmsToStr(CST_ICMS);
      ...
      CDS_C170CST_IPI.AsString      := CstIpiToStr(CST_IPI);
      ...
      CDS_C170CST_PIS.AsString      := CstPisToStr(CST_PIS);
      ...
      CDS_C170CST_COFINS.AsString        := CstCofinsToStr(CST_COFINS);
