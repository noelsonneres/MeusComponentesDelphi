...
type
  TRestDWForm = class(TForm)
    ...
    procedure RESTServicePooler1Create(Sender: TObject);
  Private
...
procedure TRestDWForm.RESTServicePooler1Create(Sender: TObject);
begin
 RESTServicePooler1.DefaultPage.Text := LoadHTMLFile('.\serveronline.html');
end;
...
Begin
  RESTServicePooler1.RootPath := IncludeTrailingPathDelimiter(ExtractFilePath(ParamSTR(0)));
