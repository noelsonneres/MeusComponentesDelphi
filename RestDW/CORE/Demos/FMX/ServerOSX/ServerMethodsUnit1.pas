...
uses SysUtils, Classes,  uRESTDWBase, uDWConsts, uDWConstsData, uDWJSONTools, uDWJSONObject,
     System.JSON,  ServerUtils, SysTypes,
     FireDAC.Dapt,
     FireDAC.Phys.FBDef,
     FireDAC.UI.Intf, FireDAC.Stan.Intf, FireDAC.Stan.Option,
...
Begin
 If Params.ItemsString['SQL'] <> Nil Then
  Begin
   ...
   JSONValue.Encoding := GetEncoding(FrmGeral.RESTServicePooler1.Encoding);
