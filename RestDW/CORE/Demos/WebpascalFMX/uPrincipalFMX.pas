...
begin
 ...
 RESTServicePooler1.ServerParams.HasAuthentication := False;
 RESTServicePooler1.ServerParams.UserName := eUsername.Text;
 RESTServicePooler1.ServerParams.Password := ePassword.Text;
